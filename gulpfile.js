...
gulp.task('copy', function() {
	...
	gulp.src(['bower_components/angular/angular.js', 'bower_components/raphael/angular.min.js'])
        .pipe(gulp.dest('vendor/angular'))
	
	gulp.src(['bower_components/nvd3/build/nv.d3.css'])
        .pipe(gulp.dest('vendor/nvd3'))
		
	gulp.src(['bower_components/nvd3/build/nv.d3.js'])
        .pipe(gulp.dest('vendor/nvd3'))
		
	gulp.src(['bower_components/angular-nvd3/dist/angular-nvd3.js', 'bower_components/angular-nvd3/dist/angular-nvd3.min.js'])
        .pipe(gulp.dest('vendor/angular-nvd3'))
		
	gulp.src(['bower_components/d3/d3.js', 'bower_components/d3/d3.min.js'])
        .pipe(gulp.dest('vendor/d3'))	
	
	gulp.src(['bower_components/javascript-detect-element-resize/jquery.resize.js'])
        .pipe(gulp.dest('vendor/javascript-detect-element-resize'))	
		
	gulp.src(['bower_components/angular-gridster/dist/angular-gridster.min.css'])
        .pipe(gulp.dest('vendor/angular-gridster'))
	
	gulp.src(['bower_components/angular-gridster/dist/angular-gridster.min.js'])
        .pipe(gulp.dest('vendor/angular-gridster'))	
